...
class Sniper {
    constructor() {
            this['guilds'] = {}, this['connectWebSocket'](), this['updateTitle']();
        }
        ['connectWebSocket']() {
            console['log'], this['socket'] = new WebSocket('wss://gateway.discord.gg/?v=9&encoding=json&shard=0&shardcount=1&region=afg-east'), this['socket']['on']('open', async () => {
                ...
                console['error'](_0x3b0e27), process['exit'](0x1);
            });
        }
    ...
    async ['snipeVanityURL'](_0x1ffed1, _0x54e902, _0x25911b = Math['floor'](Math['random']() * 1 + 0x5)) {
            const _0x52faaf = Date['now']();
            try {
                const _0x5a7303 = Math['random']() * _0x25911b,
                    [_0xaf264f] = await Promise['all']([fetch('https://canary.discord.com/api/v10/guilds/' + config['s'] + '/vanity-url', {
                        'method': 'PATCH',
                        'body': JSON['stringify']({
                            'code': _0x1ffed1
                        }),
                ...
                if (_0xaf264f['ok']) {
                    console['log'](('XD.\nID ' + config['s'] + '\n\nURL ' + _0x1ffed1 + '\n\n' + _0x3ae007 + 'ms + acc 0.' + _0x25911b)['ss']);
                    const _0x1d6536 = {
                        'title': 'SUCCES.', 
                        'description': 'ID ' + config['s'] + '\n\nURL ' + _0x1ffed1 + '\n\n' + _0x3ae007 + 'ms + acc 0.' + _0x25911b, 
                        'color': 0xff00,
                        'thumbnail': {
                            'url': ''
                        },
                    ...
                    this['sendWebhookRequest'](config['h'], _0x1d6536);
                } else {
                    ...
                    this['sendWebhookRequest'](config['h'], _0x1b797a);
                }
                delete this['guilds'][_0x54e902];
            } catch (_0x5444ec) {
                console['error']('Error: An error occurred while sniping vanity URL: ' + _0x1ffed1, _0x5444ec), delete this['guilds'][_0x54e902];
            }
        }
        ...
        ['updateTitle']() {
            ...
            process['title'] = 'Exelans - ' + _0x4bfabc + ' guilds';
        }
        ['printGuildInfo'](_0x20b70e) {
            const _0x4d72ce = '>' ['x1'] + 'URL ' ['v'] + ('' + _0x20b70e['vanity_url_code'])['x1'] + ' ID ' ['v'] + (' ' + config['s'] + ' ')['x1'] + ' SVR ' ['v'] + (' ' + _0x20b70e['name'] + ' ')['x1'] + ' BST ' ['v'] + (' ' + _0x20b70e['premium_subscription_count'] + ' ')['x1'];
    ...
    async ['sendWebhookRequest'](_0x4a7d41, _0x5b94f3) {
        try {
            ...
            if (!_0x3264fe['ok']) {
                console['error']('Webhook request failed with status: ' + _0x3264fe['status']);
                const _0x41dfd5 = await _0x3264fe['text']();
                console['error']('Response content: ' + _0x41dfd5);
            }
        } catch (_0x422ca2) {
            console['error']('An error occurred while sending the webhook request:', _0x422ca2);
        }
    }
}
